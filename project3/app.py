...
def predict():
    ...
    try:
        ...
        # data, meta_data = ts.get_monthly(stock_symbol)

        url = 'https://www.alphavantage.co/query?function=TIME_SERIES_MONTHLY&symbol=BBCA&apikey=8CD9UTRCMSZXT59S'
        r = requests.get(url)
        data = r.json()
        ...
        return render_template('index.html', prediction=json_mylist)
